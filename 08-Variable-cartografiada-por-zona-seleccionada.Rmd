# Variable cartografiada en zona seleccionada
...
'#=======================#
  ...
  varname:
    ...
    value: P_60YMAS
    input: select
    choices: [POBTOT,POBFEM,POBMAS,P_0A2,P_0A2_F,P_0A2_M,P_3YMAS,P_3YMAS_F,P_3YMAS_M,P_5YMAS,P_5YMAS_F,P_5YMAS_M,P_12YMAS,P_12YMAS_F,P_12YMAS_M,P_15YMAS,P_15YMAS_F,P_15YMAS_M,P_18YMAS]
...
```{r oaq3, echo = TRUE, message = FALSE, warning=FALSE}
...
```{r oaq2, echo = TRUE, message = FALSE, warning=FALSE}
...
## Variables en zona seleccionada


```{r oaq1,include=TRUE, echo = FALSE, message = FALSE, warning=FALSE, results='asis'}
...
mapi<-tm_shape(basemapaloc) +
  tm_polygons(col = "gray",
              minimize = FALSE)+
 tm_shape(basemapa) + 
  tm_fill(params$varname,title=params$varname,legend.hist=TRUE ,n = 8,id="MZA",palette="RdYlBu",style=params$estilo,convert2density = FALSE) + 
  tm_borders()+
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/i828G70W9Wk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
