# Variable cartografiada por localidad
...
'#=======================#
  ...
  varname:
    ...
    value: P_60YMAS
    input: select
    choices: [POBTOT,POBFEM,POBMAS,P_0A2,P_0A2_F,P_0A2_M,P_3YMAS,P_3YMAS_F,P_3YMAS_M,P_5YMAS,P_5YMAS_F,P_5YMAS_M,P_12YMAS,P_12YMAS_F,P_12YMAS_M,P_15YMAS,P_15YMAS_F,P_15YMAS_M,P_18YMAS,P_18YMAS_F,P_18YMAS_M,P_3A5,P_3A5_F,P_3A5_M]
...
data(list=params$municipio)
```

## Variables de la localidad en la entidad
...
basic.stats <- function(dset, vars){
    for(i in 1:length(vars)){
        print(vars[i])
        gg<-ggplot(data=dset, aes(x = dset$NOM_LOC, y =          dset[[vars[i]]])) + coord_flip()+
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/y7pphSTn5fk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
